...
export const COPY: Record<string, ChapterCopy> = {
  ...
  ch2: {
    eyebrow: "其贰 · 唤星之旅 THE AWAKENING",
    title: "唤星之旅",
    hook: "夜空睡着了。跟着流萤，把星星一颗颗唤回来。",
    ...
    body: [
      ...
      "三垣居中，四象环列——中国人给天空立的法。",
      "余下的星，由你亲手唤醒。拖拽环视，点击或凝视任意一颗沉睡的星，听听它的那句诗。",
    ],
    seal: "唤",
  },
  ch3: {
  ...
  ch8: {
    ...
    body: [
      "本作品以《步天歌》为题——一卷把星官谱成韵语、便于记诵认星的旧诗。",
      "数据、开源技术与制作说明列于下方。本站为中国大学生计算机设计大赛参赛作品（信息可视化设计类）。",
      // 结语（ch8.ts 以 .ch8-coda 大字号宋体渲染最后一段）
      "千年之后，诗里的星仍在原处，我们只是换了一种读法。",
    ],
    seal: "跋",
  },
};
